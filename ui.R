                  ...
                  dashboardSidebar(width = 300,
                                   sidebarMenu(id="tabs",
                                       ...
                                       conditionalPanel(condition="input.tabselected==4",
                                           ...
                                           #                       "Social Distance" = "SD")),
                                           checkboxGroupInput("ModelSelectionValue","Select Projection Models:",
                                                              c("Institute for Health Metrics and Evaluation"="IHME",
                                                                "Los Alamos National Lab"="LANL",
                                                                "University of Texas" = "UT",
                                                                "CHIME (Schools Closed)"="CHIME1",
                                                                "CHIME (Businesses Closed)"="CHIME2",
                                                                "CHIME (Schools and Businesses Closed)"="CHIME3",
                                                                "CHIME (Social Distancing)"="CHIME4",
                                                                "CHIME (Schools Closed and Social Distancing)"="CHIME5",
                                                               "CHIME (Businesses Closed and Social Distancing)"="CHIME6",
                                                                "CHIME (Schools Closed, Businesses Closed, and Social Distancing)"="CHIME7",                                                                                                                                
                  ...
                  dashboardBody(
                    ...
                    '))),
                      tags$script(HTML('
                                   ...
                                   $("header").find("nav").append(\'<span class="myClass"> COVID-19 Health Assessment Dashboard Beta v0.6.2</span>\');
                                   })
                                   ')),
