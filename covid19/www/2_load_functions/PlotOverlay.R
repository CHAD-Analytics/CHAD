...
PlotOverlay<-function(ChosenBase, IncludedCounties, IncludedHospitals,ModelIDList, DaysProjected, StatisticType,CONUSSelect,RedLine){
  ...
  if (StatisticType == "Hospitalizations") {
    ...
    if (CONUSSelect == "CONUS"){
        ...
        CU20x10PSD_State <- data.frame(CU20x10PSD_State$Date,CU20x10PSD_State$report_50*HRate,CU20x10PSD_State$report_25*HRate,CU20x10PSD_State$report_75*HRate)
        CU20x5PSD_State <- data.frame(CU20x5PSD_State$Date,CU20x5PSD_State$report_50*HRate,CU20x5PSD_State$report_25*HRate,CU20x5PSD_State$report_75*HRate)
        CU20w10PSD_State <- data.frame(CU20w10PSD_State$Date,CU20w10PSD_State$report_50*HRate,CU20w10PSD_State$report_25*HRate,CU20w10PSD_State$report_75*HRate)
        CU20w5PSD_State <- data.frame(CU20w5PSD_State$Date,CU20w5PSD_State$report_50*HRate,CU20w5PSD_State$report_25*HRate,CU20w5PSD_State$report_75*HRate)      
    ...
    if (CONUSSelect == "CONUS"){
      ...
      CU20x10PSD_State <- data.frame(CU20x10PSD_State$Date,CU20x10PSD_State$report_50*ICRate,CU20x10PSD_State$report_25*ICRate,CU20x10PSD_State$report_75*ICRate)
      CU20x5PSD_State <- data.frame(CU20x5PSD_State$Date,CU20x5PSD_State$report_50*ICRate,CU20x5PSD_State$report_25*ICRate,CU20x5PSD_State$report_75*ICRate)
      CU20w10PSD_State <- data.frame(CU20w10PSD_State$Date,CU20w10PSD_State$report_50*ICRate,CU20w10PSD_State$report_25*ICRate,CU20w10PSD_State$report_75*ICRate)
      CU20w5PSD_State <- data.frame(CU20w5PSD_State$Date,CU20w5PSD_State$report_50*ICRate,CU20w5PSD_State$report_25*ICRate,CU20w5PSD_State$report_75*ICRate)      
      
      colnames(CU20x10PSD_State)<-c("ForecastDate","Expected ICU Patients","Lower Estimate","Upper Estimate")
      CU20x10PSD_State$ID<-rep("CU20SCx10",nrow(CU20x10PSD_State))
      colnames(CU20x5PSD_State)<-c("ForecastDate","Expected ICU Patients","Lower Estimate","Upper Estimate")
      CU20x5PSD_State$ID<-rep("CU20SCx5",nrow(CU20x5PSD_State))
      colnames(CU20w10PSD_State)<-c("ForecastDate","Expected ICU Patients","Lower Estimate","Upper Estimate")
      CU20w10PSD_State$ID<-rep("CU20SCw10",nrow(CU20w10PSD_State))
      colnames(CU20w5PSD_State)<-c("ForecastDate","Expected ICU Patients","Lower Estimate","Upper Estimate")
      CU20w5PSD_State$ID<-rep("CU20SCw5",nrow(CU20w5PSD_State))      
    ...
    if (CONUSSelect == "CONUS"){
      ...
      CU20x10PSD_State <- data.frame(CU20x10PSD_State$Date,CU20x10PSD_State$report_50*VCRate,CU20x10PSD_State$report_25*VCRate,CU20x10PSD_State$report_75*VCRate)
      CU20x5PSD_State <- data.frame(CU20x5PSD_State$Date,CU20x5PSD_State$report_50*VCRate,CU20x5PSD_State$report_25*VCRate,CU20x5PSD_State$report_75*VCRate)
      CU20w10PSD_State <- data.frame(CU20w10PSD_State$Date,CU20w10PSD_State$report_50*VCRate,CU20w10PSD_State$report_25*VCRate,CU20w10PSD_State$report_75*VCRate)
      CU20w5PSD_State <- data.frame(CU20w5PSD_State$Date,CU20w5PSD_State$report_50*VCRate,CU20w5PSD_State$report_25*VCRate,CU20w5PSD_State$report_75*VCRate)      
      
      colnames(CU20x10PSD_State)<-c("ForecastDate","Expected Ventilator Patients","Lower Estimate","Upper Estimate")
      CU20x10PSD_State$ID<-rep("CU20SCx10",nrow(CU20x10PSD_State))
      colnames(CU20x5PSD_State)<-c("ForecastDate","Expected Ventilator Patients","Lower Estimate","Upper Estimate")
      CU20x5PSD_State$ID<-rep("CU20SCx5",nrow(CU20x5PSD_State))
      colnames(CU20w10PSD_State)<-c("ForecastDate","Expected Ventilator Patients","Lower Estimate","Upper Estimate")
      CU20w10PSD_State$ID<-rep("CU20SCw10",nrow(CU20w10PSD_State))
      colnames(CU20w5PSD_State)<-c("ForecastDate","Expected Ventilator Patients","Lower Estimate","Upper Estimate")
      CU20w5PSD_State$ID<-rep("CU20SCw5",nrow(CU20w5PSD_State))      
