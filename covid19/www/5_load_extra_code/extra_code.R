...
BaseSummaryList <- setNames(data.frame(matrix(ncol = 20, nrow = 0)),
                            c("ID", "Base", "Branch", "Operational", "MAJCOM","Region", "lat", "long",
...
for (i in 1:nrow(AFBaseLocations)){
  ...
  # Risk level
  if (weeklyCaseCapita < 1*7){
    risk = "Level 1"
  } else if(weeklyCaseCapita < 10*7){
    risk = "Level 2"
  } else if(weeklyCaseCapita < 25*7){
    risk = "Level 3"
  } else if(weeklyCaseCapita > 25*7){
    risk = "Level 4"
  } else{
