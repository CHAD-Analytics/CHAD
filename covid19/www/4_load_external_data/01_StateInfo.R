...
# Create StateList for use in other data sets downstream
  ...
  Most_Recent_Extension <- as.data.frame(extensions[(nrow(extensions)-17), ])
  ...
  Most_Recent_Extension$'extensions[(nrow(extensions) - 17), ]' <- as.character(Most_Recent_Extension$'extensions[(nrow(extensions) - 17), ]')
